...
associates remote hosts with the number of bytes transferred to them.
"""
...
def generate_log_report(logfile):
    ...
    for line in logfile:
        ...
        try:
            ...
            continue
        report_dict.setdefault(line_dict['remote_host'], bytes_sent)
    return report_dict
...
if __name__ == "__main__":
    ...
    for i, value in log_report.items():
        print(f"{i} => {value}")
    infile.close()